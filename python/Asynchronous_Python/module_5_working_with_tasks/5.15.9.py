# Задание: Написать программу, которая симулирует процесс посадки пассажиров в автобус.
# У каждого пассажира есть своя скорость посадки, и автобус ожидает определенное время (5 секунд), прежде чем уехать.
# Если пассажир не успевает сесть в автобус за отведенное время, он остается и ждет следующего.
...
async def board_passenger(passenger: dict) -> None:
    name = passenger.get("Name")
    speed = passenger.get("Speed")
    job = passenger.get("Job")
