...
def get_result(url: str):
    with webdriver.Chrome(options_chrome) as driver:
        ...
        for cookie in cookies_list:
            ...
            skills_list = len(driver.find_elements(By.CSS_SELECTOR, "skillsList > li"))
            age = int(driver.find_element(By.ID, "age").text.split()[1])

            if skills_list > min_skill or (skills_list == min_skill and max_age > age):
                min_skill = skills_list
                max_age = age
