# Ваша задача: написать программу с использованием пула потоков для вычисления суммы порядковых номеров букв в каждом предложении из заданного списка messages = [](список аналогичен списку из прошлой задачи).
# Каждая буква имеет свой порядковый номер в алфавите, определенный в словаре letter_values. Программа должна вывести предложение с максимальной суммой порядковых номеров букв.
#
# Список messages=[] и словарь letter_values={}, вшиты в задачу, копировать их не нужно.
...
#                  'э': 31, 'ю': 32, 'я': 33}
# Например:
# Слово "между" = состоит из "м": 14, "е": 6, "ж": 8, "д": 5, "у": 21, и сумма чисел равна 54 (14+6+8+5+21=54),
# А предложение, 'Многопоточное программирование может быть сложным из-за потенциальных проблем с синхронизацией и гонками за ресурсы.' имеет сумму чисел 1398.
#
# При подсчёте символа, приведите его в нижний регистр с помощью функции .lower()
#
# Вывод результатов: Программа должна вывести предложение с максимальной суммой порядковых номеров букв.
#
# Пример вывода:
#
# # Одно предложение, без кавычек и суммы, только текст.
#
...
class SentenceAnalyzer:
    ...
    def run(self, messages: list) -> str:
        with self.executor as executor:
            future_to_msg = {
                executor.submit(self.calculate, msg): msg for msg in messages
            }
            ...
            for future in as_completed(future_to_msg):
                ...
                current_sentence = future_to_msg[future]
