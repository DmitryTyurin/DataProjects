...
class DataDriver:
    def __init__(self):
        self.url = "https://parsinger.ru/selenium/7/7.3.4/index.html"
    ...
    def get_result(self, driver, url):
        ...
        self.action.context_click(context_area).perform()
        driver.find_element(By.CSS_SELECTOR, '[data-action="get_password"]').click()
